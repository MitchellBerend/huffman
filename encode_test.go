...
func TestEncodeLong(t *testing.T) {
	...
	expectedNodes := []*node.Node{
		...
		node.NewNode([]byte("L"), nil, nil, 2),
		node.NewNode([]byte("P"), nil, nil, 3),
		node.NewNode([]byte("Q"), nil, nil, 4),
		node.NewNode([]byte("T"), nil, nil, 5),
		node.NewNode([]byte("U"), nil, nil, 6),
		node.NewNode([]byte("x"), nil, nil, 7),
		node.NewNode([]byte("I"), nil, nil, 8),
		node.NewNode([]byte("f"), nil, nil, 9),
		node.NewNode([]byte("h"), nil, nil, 10),
		node.NewNode([]byte("b"), nil, nil, 11),
		node.NewNode([]byte("g"), nil, nil, 12),
		node.NewNode([]byte("q"), nil, nil, 13),
		node.NewNode([]byte("v"), nil, nil, 14),
		node.NewNode([]byte("."), nil, nil, 15),
		node.NewNode([]byte("d"), nil, nil, 16),
		node.NewNode([]byte("p"), nil, nil, 17),
		node.NewNode([]byte("m"), nil, nil, 18),
		node.NewNode([]byte("o"), nil, nil, 19),
		node.NewNode([]byte("c"), nil, nil, 20),
		node.NewNode([]byte("r"), nil, nil, 21),
		node.NewNode([]byte("l"), nil, nil, 22),
		node.NewNode([]byte("n"), nil, nil, 23),
		node.NewNode([]byte("t"), nil, nil, 24),
		node.NewNode([]byte("u"), nil, nil, 25),
		node.NewNode([]byte("a"), nil, nil, 26),
		node.NewNode([]byte("i"), nil, nil, 27),
		node.NewNode([]byte("s"), nil, nil, 28),
		node.NewNode([]byte("e"), nil, nil, 29),
		node.NewNode([]byte(" "), nil, nil, 30),
	}
